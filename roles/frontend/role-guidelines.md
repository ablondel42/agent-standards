...
3. Load `roles/frontend/_index.md` to determine which additional guidance files are relevant to the task.
...
## Retrieval strategy
**Start here:**
1. Load `roles/frontend/role-guidelines.md` (this file)
2. Load `roles/frontend/_index.md` for retrieval guidance
...
- Frontend quality files (`roles/frontend/quality/`)
